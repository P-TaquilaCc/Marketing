...
<head>
    ...
    <div class="mobile_nav">
        ...
        <div class="mobile_nav_items">
            <a href="{{ route('admin.dashboard') }}"><i class="fas fa-home"></i></i><span>Inicio</span></i></a>
            <a href="{{-- route('admin.list') --}}"><i class="fas fa-store"></i></i><span>Negocio</span></i></a>
            <a href=""><i class="fas fa-chart-bar"></i><span>Reportes</span></i></a>
            <a href="{{ route('admin.listCategory') }}"><i class="fas fa-edit"></i><span>Categorías</span></i></a>
            <a href=""><i class="fas fa-list-alt"></i><span>Pedidos</span></i></a>
            <a href=""><i class="fas fa-chart-pie"></i><span>Planes</span></i></a>
